...
fn a_nickname_outranks_the_profile_name_the_person_chose() {
    // Her real record: she calls herself Dot, Pippijn typed Dorothy Example.
    let c = json!({
        "uuid": "fb07a20e", "name": "", "given_name": "",
        "profile": {"given_name": "Dot", "lastname": ""},
        "nickname": {"name": "", "given_name": "Dorothy", "family_name": "Example"}
    });
    assert_eq!(display_name_of(&c).as_deref(), Some("Dorothy Example"));
}
